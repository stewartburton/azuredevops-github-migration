...
def sanitize_github_name(name: str) -> str:
    ...
    sanitized = re.sub(r'-+', '-', sanitized)  # Replace multiple dashes with single dash
...
def generate_labels_for_work_item(work_item: Dict[str, Any], 
                                 work_item_mapping: Dict[str, str] = None,
                                 state_mapping: Dict[str, str] = None) -> List[str]:

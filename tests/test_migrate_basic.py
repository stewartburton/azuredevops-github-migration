...
class TestGitHubClient(unittest.TestCase):
    ...
    def test_validate_repo_name(self):
        ...
        self.assertFalse(
            self.client._validate_repo_name("invalid@repo")
        )  # special char
...
class TestConfigurationHandling(unittest.TestCase):
    ...
    def setUp(self):
        ...
        config_data = {
            ...
            "github": {"token": "test-token", "organization": "test-github-org"},
    ...
    def test_environment_variable_substitution(self):
        ...
        config = {"section": {"key": "${TEST_VAR}", "other_key": "normal_value"}}
...
class TestFileStructure(unittest.TestCase):
    ...
    def test_config_template_exists(self):
        ...
        self.assertTrue(
            os.path.exists("config/config.template.json"),
            "config/config.template.json should exist",
        )
    ...
    def test_documentation_exists(self):
        ...
        docs = [
            "README.md",
            "docs/user-guide/HOW_TO_GUIDE.md",
            "docs/user-guide/TESTING.md",
            "docs/user-guide/PRE_MIGRATION_CHECKLIST.md",
        ]
        for doc in docs:
...
if __name__ == "__main__":
    ...
    test_classes = [TestBasicFunctionality, TestFileStructure, TestScriptSyntax]

    # Add import-dependent tests if available
    if IMPORTS_AVAILABLE:
        test_classes.extend(
            [TestAzureDevOpsClient, TestGitHubClient, TestConfigurationHandling]
        )
